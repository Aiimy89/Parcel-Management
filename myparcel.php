       ...
       <!-- box-header -->
        ...
        <nav>
            <ul class="box-primary-nav">
                ...
                <li><a href="about.html">My Parcels</a> <i class="ion-ios-circle-filled color"></i></li>
				<li><a href="parcelRegister.html">Register Parcel</a></li>
            </ul>
        </nav>
        <!-- end nav -->  
    </div>
    ...
    function displaySpecificUserInfo()
{
    if (isset($_SESSION["matricNo"])) {
        ...
        // Fetch parcels for the logged-in user based on matricNo
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<a href="parcelinfo.php?trackNo=' . $row['trackNo'] . '">Detail</a>';
                echo '</div>';
            }
        } else {
            echo '<p style="text-align:center">No parcel registered.</p>';
        }
    ...
    <div class="container main-container clearfix"> 
        <a href="parcelRegister.php" class="button-link">+</a>
    </div>
    <!-- end Main container -->
